    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <a href="report-reorganized.php" class="link-card">
            <div class="text-center">
                ...
                <h3 class="link-card-title" data-i18n="report.type_reorganized">ප්රතිසංවිධාන සමාජ</h3>
                <p class="link-card-desc" data-i18n="report.desc_reorganized">වර්ෂය සහ දිස්ත්රික්කය අනුව ප්රතිසංවිධාන සමාජ වාර්තාව</p>
            </div>
        </a>
