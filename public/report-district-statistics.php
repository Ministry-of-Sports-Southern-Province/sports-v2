...
<main class="container mx-auto px-4 py-8">
    ...
    <div id="reportOutput" class="content-card" style="min-height: 400px; background: white; border: 1px solid #e5e7eb; border-radius: 8px; padding: 20px;">
        <div class="text-center py-8 text-gray-500">
            <p>වාර්තා පූරණය වෙමින්...</p>
        </div>
    </div>
...
<?php
$scripts = ['../assets/js/report-district-statistics.js'];
