...
<main class="container mx-auto px-4 py-8 max-w-4xl">
    <form id="editClubForm" class="space-y-6">
        ...
        <!-- Equipment Section - Managed Separately -->
        <div class="section-card">
            <h2 class="section-heading" data-i18n="form.equipment_information">ක්‍රීඩා උපකරණ</h2>
            <div class="p-4 bg-blue-50 border border-blue-200 rounded">
                <p class="text-sm text-slate-700" data-i18n="form.equipment_managed_separately">Sports equipment is now managed separately through the Equipment Management section. Use the dedicated equipment management page to add or modify year-wise equipment records for this club.</p>
            </div>
        </div>
