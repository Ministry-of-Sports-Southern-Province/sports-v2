    ...
    <form id="editClubForm" class="space-y-6">
        ...
        <div class="section-card">
            ...
            <div class="mb-4">
                ...
                <select id="gnDivision" name="gnDivision" data-i18n-placeholder="placeholder.select">
                    <option value=""></option>
                </select>
        ...
        <div class="section-card">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="regNumberFull" name="regNumber" readonly
        ...
        <div class="flex justify-end space-x-4">
            ...
            <button type="submit" id="submitBtn"
                ...
                data-i18n="button.update_club">යාවත්කාලීන කරන්න</button>
        </div>
    </form>
</main>
