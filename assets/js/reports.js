...
function loadDistricts() {
  fetch("../api/locations.php?type=district")
    ...
    .then((data) => {
      if (data.success) {
        [
          document.getElementById("reorgDistrict"),
...
function updateReportOptions() {
  ...
  document
    .getElementById("reorganizedOptions")
    .classList.toggle("hidden", type !== "reorganized");
  document
    .getElementById("registeredOptions")
    .classList.toggle("hidden", type !== "registered");
  document
    .getElementById("equipmentOptions")
    .classList.toggle("hidden", type !== "equipment");
}
